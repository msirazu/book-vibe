const ReadBookList = ({ book }) => {
    ...
    return (
        <div className="flex gap-5 border border-gray-300 rounded-xl p-3">
            <div className="bg-three px-15 py-5 rounded-lg">
                <img className="w-25 h-30" src={image} alt={bookName} />
            </div>
